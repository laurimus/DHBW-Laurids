...
public class Flashlight {
    ...
    public char getSizeCategory() { return sizeCategory; }
    public void setSizeCategory(char sizeCategory) { this.sizeCategory = sizeCategory; }

    public String getBrand() { return brand; }
    public void setBrand(String brand) { this.brand = brand; }

    public byte getBatteryCount() { return batteryCount; }
    ...
    public short getWeightInGrams() { return weightInGrams; }
    public void setWeightInGrams(short weightInGrams) { this.weightInGrams = weightInGrams; }

    public int getLumenOutput() { return lumenOutput; }
    public void setLumenOutput(int lumenOutput) { this.lumenOutput = lumenOutput; }
    ...
    public LocalDateTime getLastMaintenanceDateTime() { return lastMaintenanceDateTime; }
    public void setLastMaintenanceDateTime(LocalDateTime lastMaintenanceDateTime) { this.lastMaintenanceDateTime = lastMaintenanceDateTime; }
    ...
    public float getBatteryLifeInHours() { return batteryLifeInHours; }
