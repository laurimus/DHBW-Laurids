...
set "file01=shared/Aircraft.java"
set "file02=tcas/ITrafficCollisionAvoidanceSystem.java"
set "file03=tcas/TrafficCollisionAvoidanceSystem.java"
set "file04=main/Application.java"
