...
set "file01=Engine.java"
set "file02=IFuelSource.java"
set "file03=FuelEngine.java"
set "file04=IEnergySource.java"
set "file05=ElectricEngine.java"
set "file06=Application.java"
