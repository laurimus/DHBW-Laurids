...
set "file01=01_data/flights.csv"
set "file02=02_implementation/Flight.java"
set "file03=02_implementation/Airport.java"
set "file04=02_implementation/Application.java"
